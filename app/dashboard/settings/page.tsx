...
export default function SettingsPage() {
  ...
  function togglePreference(key: keyof TeacherPreferences) {
    const nextValue = !settings.preferences[key];
    updateTeacherPreferences({ [key]: nextValue });
  }
  ...
  function handleInstituteSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    updateInstituteProfile(institute);
